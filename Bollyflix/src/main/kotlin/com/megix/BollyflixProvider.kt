...
class BollyflixProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "/south-hindi-dubbed/" to "Sauth Movies",
        "/movies/bollywood/" to "Bollywood Movies",
        "/web-series/netflix/" to "Netflix Series",
        "/web-series/amazon-prime-video/" to "Amazon Prime Series",
        "/web-series/hotstar/" to "Jio Hotstar",
        "/web-series/voot-select/" to "Voot-Select",
        "/web-series/mx-player-originals/" to "MX-Player-Originals"
    )
