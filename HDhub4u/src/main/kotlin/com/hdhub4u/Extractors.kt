...
class Hubdrive : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        val doc = app.get(url, timeout = 5000, interceptor = cfKiller).documentLarge
...
class HubCloud : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        val href = try {
            when {
                ...
                "/drive/" in urlToUse -> {
                    ...
                    val rawHref = app.get(urlToUse, interceptor = cfKiller, timeout = 5).document.select("#download").attr("href")
        ...
        val document = app.get(href, interceptor = cfKiller, timeout = 5).document
